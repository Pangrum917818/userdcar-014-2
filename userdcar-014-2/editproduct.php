    ...
    <div class="container">
        <div class="row">
            <form action="saveproduct.php" class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="description" class="control-label col-md-3">model: </label>
                        <div class="col-md-9">
                            <textarea  name="txtmodel" class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="price" class="control-label col-md-3">Color: </label>
                        <div class="col-md-9">
                            <input type="text" name="txtcol" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
